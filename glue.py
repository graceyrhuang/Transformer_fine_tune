...
def glue_convert_examples_to_features(
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        if output_mode == "classification":
            # print('examle_label:', type(example.label))
...
class BoolQProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        with open(os.path.join(data_dir, 'train.jsonl')) as json_file:
            js_lines = list(json_file)

        return self._create_examples(js_lines, "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        with open(os.path.join(data_dir, 'val.jsonl')) as json_file:
            js_lines = list(json_file)
        return self._create_examples(js_lines, "dev")
